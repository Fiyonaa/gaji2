		...
		<div class="block xl:grid grid-cols-2 gap-4">
			...
			<div class="hidden xl:flex flex-col min-h-screen">
				<a href="" class="-intro-x flex items-center pt-5">
					...
					<span class="text-white text-lg ml-3"><span class="font-medium">APP GAJI</span> </span>
				</a>
				<div class="my-auto">
					<img alt="Midone Tailwind HTML Admin Template" class="-intro-x w-1/2 -mt-16"
						src="<?= base_url('assets/midone') ?>/dist/images/illustration.svg">
					<div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">
						Selamat Datang !!
						<br>
						Aplikasi Penggajian
					</div>
					<div class="-intro-x mt-5 text-lg text-white">PT TRAVELMATE</div>
				</div>
			</div>
			<!-- END: Login Info -->
			<!-- BEGIN: Login Form -->
